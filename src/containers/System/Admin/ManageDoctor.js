    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', note = '', paymentId = '',
                ...
                selectedProvince = '', selectedSpecialty = '', clinicId = '', selectedClinic = ''
            ...
            <div className='manage-doctor-container'>
                ...
                <div className='more-infor'>
                    ...
                    <div className='content-right'>
                        ...
                        <textarea className='form-control' onChange={(event) => this.handleOnChangeText(event, 'description')} value={this.state.description}>
                ...
                <div className='manage-doctor-editor'>
                    <MdEditor style={{ height: '500px' }} renderHTML={text => mdParser.render(text)}
                        value={this.state.contentMarkdown} onChange={this.handleEditorChange} />
                </div>
...
const mapStateToProps = state => { // inject state Redux in React
    return {
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getAllRequiredDoctorInfor: () => dispatch(actions.getRiquiredDoctorInfo()),
